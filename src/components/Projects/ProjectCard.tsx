...
const ProjectCard = ({ project, onClick, viewLabel = "View" }: Props) => (
  ...
  >
    ...
    <h3 className="text-lg font-bold text-center text-blue-600 dark:text-blue-400 mb-2 group-hover:text-blue-500 dark:group-hover:text-blue-300 transition leading-snug">
      {project.title}
    </h3>
